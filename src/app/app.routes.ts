    ...
    children: [
      {
        path: 'etapas',
        loadComponent: () =>
          import('./pages/etapas/etapas.component').then(
            (m) => m.EtapasComponent
          ),
      },
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './pages/generar-acta-inicio/generar-acta-inicio.component'
          ).then((m) => m.GenerarActaInicioComponent),
      },
      {
        path: 'documentos-soporte',
        loadComponent: () =>
          import(
            './pages/documentos-soporte/documentos-soporte.component'
